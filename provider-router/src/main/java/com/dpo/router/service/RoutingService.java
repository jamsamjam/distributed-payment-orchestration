package com.dpo.router.service;

import com.dpo.router.model.CircuitBreakerState;
import com.dpo.router.model.ProviderStats;
import com.dpo.router.model.RouteRequest;
import com.dpo.router.model.RouteResponse;
...
public class RoutingService {
    ...
    @PostConstruct
    public void init() {
        providers.put("stripe", new ProviderStats("stripe",  80,  200, 0.029));
        providers.put("adyen",  new ProviderStats("adyen",  100,  300, 0.025));
        providers.put("paypal", new ProviderStats("paypal", 150,  400, 0.027));
    }
